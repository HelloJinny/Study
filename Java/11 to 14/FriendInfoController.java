...
class FriendInfoController
{
	...
	public void addFriend(int choice)
	{
		...
		String name = null, phoneNum = null, address = null,
				ban = null, work = null, major = null, company = null;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if(choice == 1)  // 중학교
		{
			...
			ban =keyboard.nextLine();
			
			System.out.printf("%s, %s, %s, %s \n", name, phoneNum, address, ban);

			friend[numOfFriends++] = new MiddleFriend(name, phoneNum, address, ban);  // 다형성
		}
